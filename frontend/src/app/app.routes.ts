...
export const routes: Routes = [
  ...
  { path: 'councils/:id/edit', loadComponent: () => import('./features/council/council-edit/council-edit').then(m => m.CouncilEdit) },
  ...
  { path: 'agents/:id/edit', loadComponent: () => import('./features/agent/agent-edit/agent-edit').then(m => m.AgentEdit) },
